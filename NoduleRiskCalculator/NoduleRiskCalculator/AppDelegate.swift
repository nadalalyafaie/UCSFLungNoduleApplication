...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        // Override point for customization after application launch. Get rid of to make the app start on patient id
        NSUserDefaults.standardUserDefaults().setBool(false, forKey: "doctorRegistered")
